...
function startGame() {
    ...
    nextButton.classList.remove('hide'); // Move this line here
...
function addSound(correct) {
  if (correct) {
    const correctSound = new Audio('assets/sounds/interface-124464.mp3');
    correctSound.play();
  }
}
...
const questions = [
  {
    question: 'Who is an best graphic designer?',
    answers: [
      { text: 'Zarina', correct: true },
      { text: 'Rakhat', correct: false }
    ]
  },
  {
  ...
  {
    question: 'Is graphic design fun?',
    answers: [
